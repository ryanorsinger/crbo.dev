...
class CreateDevicesTable extends Migration {
	...
	public function up()
	{
		Schema::create('devices', function($table)
        {
            ...
            $table->dateTime('created_on_date')->nullable();
            ...
            $table->string('refurb_loud_fans', 25)->nullable()->nullable();
            $table->string('refurb_refurbished_by', 50)->nullable()->nullable();
            $table->string('refurb_grade_abc', 50)->nullable()->nullable();
            $table->string('replacement_part1', 50)->nullable()->nullable();
            $table->float('replacement_part1_cost')->nullable()->nullable();
            $table->string('replacement_part2', 50)->nullable()->nullable();
            $table->float('replacement_part2_cost')->nullable()->nullable();
            $table->string('replacement_part3', 50)->nullable()->nullable();
            $table->float('replacement_part3_cost')->nullable()->nullable();
            $table->string('replacement_part4', 50)->nullable()->nullable();
            $table->float('replacement_part4_cost')->nullable()->nullable();
